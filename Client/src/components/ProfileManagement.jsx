...
function ProfileManagement() {
  ...
  return (
    <div className='p-3 flex mx-auto bg-white text-slate-700'>
      <Sidebar onLogout={onLogOut} />
      <main className="bg-white text-gray-700 w-full flex flex-col items-center justify-center mainsection">
        ...
        <div className='flex justify-between mt-5 mb-3'>
          <span
            ...
            className='text-slate-700 cursor-pointer mb-4'
          >
            Delete account
          </span>
          <br />
          <span onClick={handleSignOut} className='text-slate-600 text-2xl text-semibold cursor-pointer'>
            Sign out
          </span>
        </div>
