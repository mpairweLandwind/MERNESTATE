        ...
        <div className="singlePage">
          <div className="details">
            <div className="wrapper ml-2">
              {listing && listing.imageUrls && <Slider images={listing.imageUrls} />}
              ...
              <>
                ...
                <div className="listHorizontal">
                  <div className="feature">
                    ...
                    <div className="featureText">
                      <span>School</span>
                      <p>{listing.postDetail.school > 999 ? listing.postDetail.school / 1000 + "km" : listing.postDetail.school + "m"} away</p>
                    </div>
                  </div>
                  <div className="feature">
                    <img src="/bus.png" alt="" />
